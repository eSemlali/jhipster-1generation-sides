<template>
  <div class="sidebar">
    <div class="menu-items">
      <b-navbar-nav>
        <b-nav-item class="items" to="/" exact>
          <span>
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer items" data-cy="entity">
        ...
        <b-nav-item-dropdown class="items" id="languagesnavBarDropdown" right v-if="languages && Object.keys(languages).length > 1">
